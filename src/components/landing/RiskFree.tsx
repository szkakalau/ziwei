      ...
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="mt-10 grid gap-5 sm:mt-16 sm:gap-6 sm:grid-cols-3">
          {items.map((item) => (
            <div
              key={item.title}
              className="flex flex-col items-center rounded-sm bg-panel/80 p-6 shadow-xs backdrop-blur-md text-center transition-all duration-300 hover:shadow-md hover:-translate-y-px"
            >
