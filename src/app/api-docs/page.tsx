  ...
  return (
    <main className="min-h-screen bg-void text-ink px-5 py-8 max-w-2xl mx-auto">
      ...
      <section className="mb-8">
        <h2 className="text-ink-muted text-sm font-semibold mb-3 flex items-center gap-2">
        ...
        <div className="rounded-lg bg-gold/[0.03] border border-gold/10 p-3 font-mono text-xs text-ink-muted">
        ...
        {[
          ...
          <div key={ep.path} className="mb-4 rounded-xl bg-gold/[0.02] border border-gold/10 overflow-hidden">
            <div className="flex items-center gap-3 px-4 py-3 border-b border-gold/[0.04]">
              ...
              <span className="text-ink-dim text-xs ml-auto">{ep.desc}</span>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    className="absolute top-2 right-2 p-1.5 rounded hover:bg-black/[0.05] transition-colors"
                  >
                    {copied === ep.path + "-req"
      ...
      {/* Rate Limits */}
      <section className="mb-8 rounded-xl bg-gold/[0.02] border border-gold/10 p-5">
