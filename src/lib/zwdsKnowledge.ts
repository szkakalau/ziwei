...
export function getStarBrief(name: string): string {
  const briefs: Record<string, string> = {
    ...
    // ── Batch 3/3: 24 Final Stars ──
    guchen: "Solitary by nature. Independence is your gift and your risk. The right partner respects your need for space.",
    solitary: "Self-sufficient lone wolf. Solitude is chosen; loneliness is suffered. Communicate your needs.",
    guasu: "Widower carrying loss's imprint. Endings mark you deeply. Grief is a season, not an identity.",
    widower: "Separation witness. Your depth in loss helps others grieve — let yourself be held too.",
    feilian: "Gossiper of social intelligence. Information flows through you. Risk: words travel further than intended.",
    gossiper: "Network node of news. Guard confidences. Trust is built on discretion.",
    posui: "Shattered revealing cracks. What breaks was already weak. Risk: seeing breakage everywhere.",
    shattered: "Fragmentation witness. Some cracks are surface; some are structural. Discern.",
    jielu: "Blocker revealing obstacles. The blocked path is redirection, not punishment. Risk: seeing blocks everywhere.",
    blocker: "Bottleneck identifier. Some barriers dissolve when approached; others require detours.",
    xunkong: "IntervalVoid of cyclical emptiness. The void is a pause, not an end. Risk: filling emptiness with anything.",
    intervalvoid: "Temporary emptiness marker. What fills the space next is being prepared. Wait.",
    fubing: "Ambush of hidden danger. Betrayals surface. Risk: paranoia destroying trust in the innocent.",
    ambush: "Hidden threat detector. Verify before committing — but do not let past betrayals prevent future intimacy.",
    guanfu: "Officialdom navigating bureaucracy. Institutional literacy is power. Risk: becoming the system you navigate.",
    officialdom: "System navigator. Formalize agreements. Institutional clarity protects personal bonds.",
    boshi: "Erudite of deep scholarship. Knowledge compounds. Risk: expertise without application or communication.",
    erudite: "Knowledge authority whose expertise is definitive. Share generously; do not lecture where conversation is invited.",
    lishi: "Strongman of endurance. Your strength serves others. Risk: the strong are allowed to be tired.",
    strongman: "Willpower incarnate. Rest is not weakness. Atlas needs a break too.",
    qinglong: "GreenDragon of renewal. Dead things revive where you walk. Risk: forcing revival where ending is right.",
    greendragon: "Spring incarnate. Not everything should be revived. Some endings are final and right.",
    jiangjun: "General of strategic command. Campaign thinking over skirmish winning. Risk: war mentality in peacetime.",
    generalstar: "War leader for sustained efforts. Long-term thinking in love and work is rare and precious.",
    zoushu: "Memorialist preserving what would be lost. Memory is unreliable — you are the backup. Risk: recording without living.",
    memorialist: "Institutional memory. The record serves the lived moment, not the reverse.",
    xishen: "JoyGod of magnetic happiness. Joy is fuel, not frivolity. Risk: becoming the happy person not allowed to struggle.",
    joygod: "Joy catalyst. Your difficult emotions are valid and need expression too.",
    suijian: "YearBuilder seeing the annual arc. Build the structure; the days will fill it. Risk: over-planning to exclusion.",
    yearbuilder: "Calendar keeper. Leave room in the architecture for what cannot be scheduled.",
    huiqi: "Gloom of honest sadness. Depth is not defect. Risk: mistaking a cloudy season for permanent climate.",
    gloom: "Shadow integrator. Clouds pass. The sky behind them is unchanged.",
    sangmen: "MourningGate at loss's threshold. Walk through — what waits beyond cannot be reached without passing through grief.",
    mourninggate: "Funeral guide. The gate is for passing through, not for living in.",
    guansuo: "Binder of sacred commitments. What you bind to now has lasting weight. Risk: chains outliving their purpose.",
    binder: "Commitment enforcer. One-sided bonds are chains, not connections. Review old obligations.",
    yinsha: "ShadowSha perceiving the repressed. What surfaces was always there, now visible. Risk: shadow identification.",
    shadowsha: "Shadow worker bringing darkness to light. Timing and consent matter. Not everyone is ready to see.",
    tiankong: "SkyVoid of boundless possibility. Options multiply. Risk: too many choices, none chosen. Commit to one path.",
    skyvoid: "Possibility holder. True freedom includes the freedom to stay.",
    tianjie: "Reliever easing long-held burdens. Relief arrives — let it in. Risk: relief-seeking as avoidance of permanent solutions.",
    reliever: "Trouble resolver. Your burdens deserve easing too.",
    earthrelief: "EarthRelief of practical help. Tangible support arrives. Risk: fixing sinks while neglecting held hands.",
  };
...
export const STAR_ARCHETYPE_MAP: Record<string, StarArchetype> = {
  ...
  // ══════════════════════════════════════════════════════════════════════
  // Batch 3/3 — 24 final minor stars: emotional, sha, doctor, year-breaker
  // ══════════════════════════════════════════════════════════════════════

  // ── Emotional & Solitude (4) ──
  guchen: { archetype: "Solitary", psychological: "Independence as identity — you thrive alone and may unconsciously resist the interdependence intimacy requires.", sociological: "Lone wolf respected for autonomy. Your self-sufficiency inspires but can also isolate.", management: "Strong in solo contributor roles and autonomous projects. Excel without supervision.", prediction: "The Solitary star signals alone-but-not-lonely periods within 3-12 months. Productive solitude — use it for deep work and self-discovery.", riskManagement: "Independence hardening into isolation: pushing away those who would stay. Solitude is chosen; loneliness is suffered.", relationships: "You need unusual amounts of space — communicate this early. The right partner respects your solitude as sacred, not threatening." },

  guasu: { archetype: "Widower", psychological: "Grief-carrier — you carry the emotional imprint of separations and endings more persistently than most.", sociological: "Witness to loss — your presence reminds groups that attachment and loss are two sides of one coin.", management: "Strong in roles supporting transitions: divorce mediation, grief counseling, organizational exits.", prediction: "The Widower star signals separation themes: endings of living arrangements or long-term bonds within 6-18 months. This clears space for what is truly yours.", riskManagement: "Loss identity: defining self by who or what you have lost rather than who you are becoming. Grief is a season, not a name.", relationships: "You understand the weight of goodbyes. This depth is a gift to partners navigating their own losses. Let yourself be held too." },

  feilian: { archetype: "Gossiper", psychological: "Information sensitivity — you notice and transmit social data others miss. Your network intelligence is formidable.", sociological: "Rumor mill node — information passes through you, amplified. Your words carry further than you realize.", management: "Strong in communications, PR, and intelligence-gathering roles. Information asymmetry is your professional advantage.", prediction: "The Gossiper star activates information flow: secrets surface, rumors spread, news travels within 1-3 months. Guard your own information carefully during this transit.", riskManagement: "Reputation risk: what you share, even casually, has consequences. Distinguish between information that serves and gossip that harms.", relationships: "Your social intelligence is attractive — but ensure confidences shared with you stay with you. Trust is built on discretion." },

  posui: { archetype: "Shattered", psychological: "Fragmentation sensitivity — you experience breaks, cracks, and discontinuities more visibly than others.", sociological: "Brokenness witness — you see what is shattered in systems and people. This uncomfortable vision serves collective repair.", management: "Strong in repair, restoration, and post-crisis reconstruction where identifying all broken pieces is step one.", prediction: "The Shattered star signals breakage: something fragile in your life will crack within 3-9 months. Not destruction — revelation. What breaks was already weak.", riskManagement: "Catastrophizing: seeing breakage everywhere creates a self-fulfilling prophecy. Some cracks are surface; some are structural. Discern.", relationships: "You see fractures in relationships others deny. This honesty serves healing — but deliver your observations with gentleness." },

  // ── Road & Void (2) ──
  jielu: { archetype: "Blocker", psychological: "Obstacle attunement — you perceive barriers before others, which can frustrate or prepare, depending on response.", sociological: "Bottleneck identifier — groups rely on you to see what is blocking progress that others overlook.", management: "Strong in process improvement and bottleneck elimination where identifying obstacles is the first step to removing them.", prediction: "The Blocker star signals obstacles: plans delayed, paths blocked within 3-6 months. The block is not punishment — it is redirection. What is blocked was not your path.", riskManagement: "Obstacle fixation: seeing blocks everywhere paralyzes action. Some barriers dissolve when approached; others require detours. Neither is failure.", relationships: "Relationship obstacles surface. Whether the block is temporary or permanent reveals itself with time and honest conversation." },

  xunkong: { archetype: "IntervalVoid", psychological: "Cyclical emptiness — you experience regular voids where meaning, motivation, or resources temporarily recede.", sociological: "Emptiness marker — your experience of void highlights what a group is missing, serving as early warning of collective depletion.", management: "Strong in cyclical planning and resource allocation. You anticipate the lean periods others forget to prepare for.", prediction: "The Interval Void star signals a temporary emptiness window within 1-3 months. The void is a pause, not an end. What fills it next is being prepared.", riskManagement: "Void panic: rushing to fill emptiness with anything available. Some voids are meant to be felt, not filled. The space prepares for what is next.", relationships: "Empty periods in relationships are normal — not every silence is a problem. Learn to be comfortable in the space between words." },

  // ── Doctor Stars (博士十二神) (6 new + already have boshi derivatives) ──
  fubing: { archetype: "Ambush", psychological: "Hidden threat sensitivity — you sense dangers concealed beneath surfaces that others accept at face value.", sociological: "Undercover protector — your alertness to hidden agendas protects groups from manipulation and betrayal.", management: "Strong in security, counterintelligence, and roles where detecting deception is the primary value.", prediction: "The Ambush star signals hidden danger: betrayals, traps, or concealed threats surface within 3-9 months. What is hidden will be revealed.", riskManagement: "Paranoia cost: seeing ambushes everywhere destroys trust. Not everyone is hiding something. Some surfaces are genuine.", relationships: "Trust cautiously under this transit. Verify before committing. But do not let past betrayals prevent future intimacy." },

  guanfu: { archetype: "Officialdom", psychological: "Institutional authority sensitivity — you navigate bureaucracy, hierarchy, and official power with intuitive understanding.", sociological: "System navigator — you know how institutions actually work, not just how they claim to work. This knowledge is power.", management: "Strong in government, regulatory, and large-organization roles where institutional literacy drives outcomes.", prediction: "The Officialdom star activates institutional engagement: dealings with government, legal systems, or large organizations within 6-12 months. Navigate the system; do not fight it.", riskManagement: "Institutional capture: becoming the system you navigate. Your literacy in bureaucracy should serve your values, not replace them.", relationships: "Official channels matter now — formalize agreements, document understandings. Institutional clarity protects personal bonds." },

  boshi: { archetype: "Erudite", psychological: "Deep scholarly orientation — you pursue knowledge for its own sake, accumulating expertise beyond practical necessity.", sociological: "Knowledge authority — your expertise is recognized and sought. People cite you as the definitive source in your domain.", management: "Strong in academia, R&D, and any role where depth of knowledge outweighs breadth of application.", prediction: "The Erudite star activates scholarly achievement: publications, degrees, certifications, and intellectual recognition within 6-18 months. Your knowledge compounds.", riskManagement: "Ivory tower isolation: expertise without application or communication. Knowledge unshared is knowledge wasted.", relationships: "Your intellectual depth attracts those seeking wisdom. Share what you know generously — but do not lecture where conversation is invited." },

  lishi: { archetype: "Strongman", psychological: "Physical and willpower endurance — you outlast others through sheer determination when talent and luck are spent.", sociological: "Enforcer — you are the muscle (literal or metaphorical) that groups depend on when strength is the primary requirement.", management: "Strong in roles requiring sustained physical or mental endurance under pressure: emergency services, manual trades, high-stress operations.", prediction: "The Strongman star activates endurance: you will be called to carry weight others cannot within 3-9 months. Your strength is for service, not domination.", riskManagement: "Strength as sole identity: the strong are allowed to be tired. Endurance without recovery becomes depletion. Rest is not weakness.", relationships: "You carry weight for those you love — a generous gift. Ensure the burden is shared. Atlas needs a break too." },

  qinglong: { archetype: "GreenDragon", psychological: "Growth and renewal energy — you embody spring-like vitality that regenerates what was dormant or dying.", sociological: "Renewal source — your presence catalyzes growth in others' lives. Gardens flourish where you walk.", management: "Strong in growth-stage organizations, revitalization projects, and roles where breathing life into dead things is the core work.", prediction: "The Green Dragon star activates renewal: stagnant situations revive, dead projects resurrect, lost hope returns within 3-9 months. Spring follows every winter.", riskManagement: "Growth obsession: forcing renewal where something genuinely needs to end. Not everything should be revived. Some endings are final and right.", relationships: "You bring life back to weary hearts — a profound gift. Ensure those you renew do not become dependent on you for their vitality." },

  jiangjun: { archetype: "General", psychological: "Strategic command orientation — you think in campaigns, not skirmishes. Long-term victory over short-term wins.", sociological: "War leader — groups mobilize around your strategic vision during extended conflicts and competitions.", management: "Strong in military, competitive strategy, and long-duration project leadership where campaign thinking beats sprint mentality.", prediction: "The General star activates strategic command: you will be called to lead a sustained effort within 6-18 months. Think in years, not weeks.", riskManagement: "War mentality in peacetime: treating every interaction as a battle exhausts allies and creates enemies. Not everything is a campaign.", relationships: "Your strategic patience is an asset in partnerships. Long-term thinking in love is rare and precious. Apply it consciously." },

  zoushu: { archetype: "Memorialist", psychological: "Record-keeping orientation — you document, preserve, and transmit what would otherwise be lost to time.", sociological: "Institutional memory — groups depend on you to remember what happened, why, and what was learned.", management: "Strong in documentation, knowledge management, and roles where preserving institutional learning prevents repeated mistakes.", prediction: "The Memorialist star activates recording: important documents, messages, and records arrive within 3-6 months. Preserve what matters — memory is unreliable.", riskManagement: "Recording without living: documenting life at the expense of experiencing it. The record serves the lived moment, not the reverse.", relationships: "You remember what matters to those you love — anniversaries, preferences, promises. This attention is a form of devotion." },

  xishen: { archetype: "JoyGod", psychological: "Joy magnetism — happiness finds you and radiates from you. Your baseline wellbeing is higher than most.", sociological: "Joy catalyst — your presence lightens group atmosphere. People feel better simply being near you.", management: "Strong in morale-critical roles: team culture, customer experience, hospitality where atmosphere is the product.", prediction: "The Joy God star activates happiness: joyful events, reunions, celebrations, and pleasant surprises within 1-6 months. Joy is not frivolous — it is fuel.", riskManagement: "Joy dependency: becoming the designated happy person who is not allowed to struggle. Your difficult emotions are valid and need expression too.", relationships: "Your joy is infectious — people want to be near you. Ensure relationships include space for your full emotional range, not just the bright notes." },

  // ── Year-Breaker Stars (岁前十二神 remaining) (6) ──
  suijian: { archetype: "YearBuilder", psychological: "Annual architect energy — you see the full-year arc while others focus on days and weeks.", sociological: "Calendar keeper — groups organize their annual rhythm around your sense of timing and seasonal flow.", management: "Strong in annual planning, fiscal-year strategy, and roles where long-cycle thinking provides competitive advantage.", prediction: "The Year Builder star activates annual planning: the year's architecture becomes visible within 1-3 months. Build the structure; the days will fill it.", riskManagement: "Over-planning: designing the year so tightly that spontaneity is excluded. Leave room for what cannot be scheduled.", relationships: "Annual relationship rhythms emerge — some seasons are for closeness, others for individual growth. Honor the cycle." },

  huiqi: { archetype: "Gloom", psychological: "Melancholy sensitivity — you experience the gray tones of life more vividly than its bright colors. This is depth, not defect.", sociological: "Shadow integrator — you help groups acknowledge the darkness they prefer to ignore, making genuine resilience possible.", management: "Strong in roles requiring sober assessment: risk management, end-of-life planning, truth-telling in denial-heavy environments.", prediction: "The Gloom star signals a heavy emotional period within 1-6 months. Sadness is not malfunction — it is honest perception of what is genuinely difficult. Feel it fully; it will pass.", riskManagement: "Depressive identification: mistaking a gloomy season for a permanent condition. Clouds pass. The sky behind them is unchanged.", relationships: "Your depth allows others to share their darkness without shame. This is sanctuary. Ensure you have someone who offers the same to you." },

  sangmen: { archetype: "MourningGate", psychological: "Threshold-of-loss sensitivity — you stand at the door between what was and what will be after bereavement.", sociological: "Funeral guide — you help communities cross the threshold of loss with dignity and ritual.", management: "Strong in hospice, funeral services, and transition management where honoring endings is the work itself.", prediction: "The Mourning Gate star signals a loss threshold within 3-12 months. Walk through the gate — what waits on the other side cannot be reached without passing through grief.", riskManagement: "Prolonged threshold-dwelling: staying at grief's door without entering or leaving. The gate is for passing through, not for living in.", relationships: "You guide others through loss — sacred and heavy work. Ensure you are not always the guide and never the one being guided." },

  guansuo: { archetype: "Binder", psychological: "Constraint sensitivity — you feel restrictions, obligations, and bonds more acutely than others.", sociological: "Commitment enforcer — groups depend on you to hold people to their word and maintain the ties that bind.", management: "Strong in contract enforcement, compliance, and roles where holding people accountable to commitments is essential.", prediction: "The Binder star activates binding commitments: contracts, promises, and formal obligations within 3-9 months. What you bind yourself to now has lasting consequences — choose carefully.", riskManagement: "Over-binding: committing to constraints that outlive their purpose. Review old obligations periodically. Some bindings were for a season, not a lifetime.", relationships: "Commitment is sacred to you — this is rare and valuable. Ensure the commitments you keep are reciprocated. One-sided bonds are chains, not connections." },

  // ── Shadow & Relief (4) ──
  yinsha: { archetype: "ShadowSha", psychological: "Shadow sensitivity — you perceive the unconscious, the repressed, the denied in yourself and others.", sociological: "Shadow worker — you bring what is hidden into light. This work is essential but uncomfortable for those invested in denial.", management: "Strong in therapeutic, investigative, and depth-oriented roles where surfacing repressed material is the core task.", prediction: "The Shadow Sha star activates shadow material: repressed emotions, hidden truths, and denied aspects surface within 3-9 months. What emerges is not new — it was always there, now visible.", riskManagement: "Shadow identification: becoming so identified with darkness that you forget the light. Shadow work serves integration, not fixation.", relationships: "You see the hidden in others — handle this perception with care. Not everyone is ready to see what you see. Timing and consent matter." },

  tiankong: { archetype: "SkyVoid", psychological: "Transcendent emptiness — unlike the Void star (地空, earthly void), this is the spaciousness above: possibility, not absence.", sociological: "Possibility holder — you represent what could be. Groups project their highest aspirations onto your perceived freedom.", management: "Strong in visionary, futuristic, and possibility-oriented roles. Excel at imagining what does not yet exist.", prediction: "The Sky Void star activates boundless possibility: options multiply, constraints dissolve within 3-9 months. The danger is not limitation but too many choices. Focus is the gift you give yourself.", riskManagement: "Possibility paralysis: so many options that none are chosen. The sky must eventually meet the ground. Commit to one path long enough to travel it.", relationships: "Your freedom is attractive — but ensure it does not become an inability to commit. True freedom includes the freedom to stay." },

  tianjie: { archetype: "Reliever", psychological: "Relief sensitivity — you notice when suffering eases and know how to facilitate that easing in others.", sociological: "Trouble resolver — you are the person called when a situation has become unbearable and needs relief, not analysis.", management: "Strong in crisis intervention, mediation, and roles where immediate relief is the deliverable, not long-term resolution.", prediction: "The Reliever star activates relief: a long-standing burden lightens, a stuck situation unsticks within 1-6 months. Relief arrives — let it in.", riskManagement: "Relief-seeking as avoidance: seeking temporary relief from problems that need permanent solutions. Relief is triage, not cure.", relationships: "You ease others' pain — a healing gift. Ensure you are not always the reliever and never the relieved. Your burdens deserve easing too." },

  earthrelief: { archetype: "EarthRelief", psychological: "Grounded relief — unlike the heavenly Reliever, this is practical, material help: the meal delivered, the bill paid, the hand offered.", sociological: "Practical helper — your help is tangible and immediate. You show up with solutions, not just sympathy.", management: "Strong in direct service, facilities, and roles where practical assistance is more valuable than strategic advice.", prediction: "The Earth Relief star activates practical help: material support, financial relief, or physical assistance arrives within 1-3 months. Accept the help — it is offered genuinely.", riskManagement: "Practical over-functioning: solving everyone's material problems while neglecting the emotional dimension. Sometimes presence matters more than provision.", relationships: "You show love through tangible action — this is beautiful. Ensure your partner also receives your emotional presence. A fixed sink is not a substitute for a held hand." },
